...
.center{
  ...
  <div class="container" >
    ...
    <div class="span5">
	    <div class="row-fluid">
		    <label class="labelroomnumber">专辑名字：</label>
		    <form action="${ctx}/Album/tolist.do" method="post" style="float: left;">
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid"  style="table-layout: fixed;" >
	      <thead class="theadone">
	        <tr>
	          ...
	          <th class="wrap" style="text-align:center;vertical-align:middle;">专辑照片</th>
	      ...
	      <tbody id="tbody">
	        <c:forEach items="${list.result}" var="item">
		        <tr>
		          ...
		          <td class="wrap" style="text-align:center;vertical-align:middle;"><img class="wrap" src="<%=request.getContextPath()%>${item.albumPhotoPath}" /></td>
 ...
 $(document).ready(function () {
   ...
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/Album/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/Album/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/Album/delete.do?id='+chk_value;
  	}
  	}else{
  ...
  $(".tcdPageCode").createPage({
     ...
     location.href="${ctx}/Album/tolist.do?currentPage="+p+"&txtname="+txtname;
     }
   });
