 ...
 <script type="text/javascript" src="${ctx}/javaScript/passenger.js"></script>
  ...
  <div class="container" style="height:1000px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">专辑新增</h3>
        
      </div>
    </div>
    
    <form action="${ctx}/Album/add.do" method="post" onsubmit="return verifyAlbum()" enctype="multipart/form-data">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>专辑名字：</label>
		        <input id="album_albumName_ID" name="albumName" type="text" style="width:97%;height:27px;float:left;" value="${user.albumName}" >
		     ...
		     <div class="span3">
		        <label>歌手名字：</label>
		        <input id="album_singerName_ID" name="singerName" type="text" style="width:100%;height:27px;" value="${user.singerName}"> 
		     </div>
		     
		       <div class="span3">
		        <label>年份：</label>
		         <input id="album_year_ID" name="year" type="text" style="width:100%;height:27px;" value="${user.year}" > 
		     </div>
	   ...
	   <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		      ...
		      <div class="span3">
		        <label>专辑图片：</label>
		        <input id="album_picture_ID" name="albumFile" type="file" style="width:100%;height:27px;" > 
		     </div>
