 ...
 <script type="text/javascript" src="${ctx}/javaScript/passenger.js"></script>
  ...
  <div class="container" style="height:1000px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">Mv新增</h3>
        
      </div>
    </div>
    
    <form action="${ctx}/Mv/add.do" method="post" onsubmit="return verifyMv()" enctype="multipart/form-data">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>MV名字：</label>
		        <input id="mv_mvName_ID" name="mvName" type="text" style="width:97%;height:27px;float:left;" value="${user.mvName}" >
		     ...
		     <div class="span3">
		        <label>歌手名字：</label>
		        <input id="mv_singerName_ID" name="singerName" type="text" style="width:100%;height:27px;" value="${user.singerName}"> 
		     </div>
		     
		       <div class="span3">
		        <label>歌曲名字：</label>
		         <input id="mv_songName_ID" name="songName" type="text" style="width:100%;height:27px;" value="${user.songName}" > 
		     </div>
	   ...
	   <div class="span12">
	      <div class="row-fluid">
		     ...
		     <div class="span3">
		        <label>年份：</label>
		         <input id="mv_year_ID" name="year" type="text" style="width:100%;height:27px;" value="${user.year}" > 
		     </div>
		      <div class="span3">
		        <label>上传MV：</label>
		        <input id="mv_video_ID" name="mvFile" type="file" style="width:100%;height:27px;" > 
		     </div>
	     ...
	     <div class="span12">
	      <div class="row-fluid">
		      ...
		      <div class="span3">
		        <label>上传MV封面：</label>
		        <input id="mv_MvPhoto_ID" name="mvPhotoFile" type="file" style="width:100%;height:27px;" > 
		     </div>
