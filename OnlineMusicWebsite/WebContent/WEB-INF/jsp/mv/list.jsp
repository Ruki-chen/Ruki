...
.center{
  ...
  <div class="container" >
    ...
    <div class="span5">
	    <div class="row-fluid">
		    <label class="labelroomnumber">MV名字：</label>
		    <form action="${ctx}/Mv/tolist.do" method="post" style="float: left;">
			   <input id="txtnameid" name="txtname" class="textone roomnumberwidth" style="border-radius:0px; border-top-left-radius:4px; border-bottom-left-radius:4px;height:26px;" type="text" placeholder="请输入MV名字" value="${txtname}">
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid"  style="table-layout: fixed;" >
	      <thead class="theadone">
	        <tr>
	          ...
	          <th class="wrap" style="text-align:center;vertical-align:middle;">MV名字</th>
	          <th class="wrap" style="text-align:center;vertical-align:middle;">歌手名字</th>
	          <th class="wrap" style="text-align:center;vertical-align:middle;">歌曲名字</th>
	          <th class="wrap" style="text-align:center;vertical-align:middle;">MV路径</th>
	          ...
	          <th class="wrap" style="text-align:center;vertical-align:middle;">年份</th>
	           <th class="wrap" style="text-align:center;vertical-align:middle;">Mv封面路径</th>
	        </tr>
	      </thead>
	      <tbody id="tbody">
	        <c:forEach items="${list.result}" var="item">
		        <tr>
		          ...
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.mvName}</td>
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.singerName}</td>
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.songName}</td>
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.mvPath}</td>
		          ...
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.year}</td>
		          <td class="wrap" style="text-align:center;vertical-align:middle;">${item.mvPhotoPath}</td>
		        </tr>
	        </c:forEach>
	      </tbody>
	    </table>
 ...
 $(document).ready(function () {
   ...
   function addfunction(){
     parent.document.getElementById('Mainid').src='${ctx}/Mv/toadd.do';
   }
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/Mv/toupdate.do?id='+chk_value;
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
   ...
   var chk_value=[];
     ...
     if(flag){
  	  parent.document.getElementById("Mainid").src='${ctx}/Mv/delete.do?id='+chk_value;
  	}
  	}else{
  ...
  $(".tcdPageCode").createPage({
     ...
     location.href="${ctx}/Mv/tolist.do?currentPage="+p+"&txtname="+txtname;
     }
   });
