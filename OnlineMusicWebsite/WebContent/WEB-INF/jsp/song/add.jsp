 ...
 <script type="text/javascript" src="${ctx}/javaScript/passenger.js"></script>
  ...
  <div class="container" style="height:1000px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">歌曲新增</h3>
        
      </div>
    </div>
    
    <form action="${ctx}/Song/add.do" method="post" onsubmit="return verifySong()" enctype="multipart/form-data">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>歌曲名字：</label>
		        <input id="song_songName_ID" name="songName" type="text" style="width:97%;height:27px;float:left;" value="${user.songName}" >
		     ...
		     <div class="span3">
		        <label>歌手名字：</label>
		        <input id="song_singerName_ID" name="singerName" type="text" style="width:100%;height:27px;" value="${user.singerName}"> 
		     </div>
		     
		       <div class="span3">
		        <label>年份：</label>
		         <input id="song_year_ID" name="year" type="text" style="width:100%;height:27px;" value="${user.year}" > 
		     </div>
		     
		       <div class="span3">
		        <label>专辑名字：</label>
		        <input id="song_albumName_ID" name="albumName" type="text" style="width:100%;height:27px;" value="${user.albumName}"> 
		     </div>
		  </div>
	    </div>
	    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	   <div class="span12">
	      <div class="row-fluid">
		     ...
		     <div class="span3">
		      ...
		      <div class="span3">
		        <label>歌词文件：</label>
		        <input id="song_lyric_ID" name="lyricFile" type="file" style="width:100%;height:27px;" > 
		     </div>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		      ...
		      <div class="span3">
		        <label>上传歌曲：</label>
		        <input id="song_songFile_ID" name="songFile" type="file" style="width:100%;height:27px;" > 
		     </div>
